  ...
  echo <<<_END
      <div class="panel panel-info width-300px">
        <div class="panel-body">
          <form method="POST" action="CO2EmiAsian.php">
            <div class="col-md-8">
...
?>
      <div id="cmt">
        <a href="CO2EmiAsian.php" style="color:blue;">Refresh Comments</a>
        <?php showComments($api,'CO2EmiAsian.php'); ?>     
      </div>
    </div>
    <!-- End Comments -->
  </div>
...
<!-- Scripts -->
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      var data,option;
      var api = 'EN.ATM.CO2E.KT';
      function showFor(){
        window.location.href='CO2EmiMM.php';
      }
      ...
      function drawChart(year) {
        $.ajax({
          ...
          success: function (GDPJson) {
            ...
            options = {
              title: 'CO2 emissions (kt) Asian '+year,
              curveType: 'function',
