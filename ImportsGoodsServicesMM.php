...
<div class="row" style="background: none;">
	<div class="row">
		...
		<div class="well col-md-8">
			...
			<h3>Imports of goods and services (% of GDP) Myanmar</h3>
			...
			<div id="curve_chart" class="well" style="width: auto; height: 500px; color:white;"></div>
				<section id="Table" style="display:none;">
					<h1>Imports of goods and services (% of GDP) Myanmar</h1>
	...
	echo <<<_END
			<div class="panel panel-info width-300px">
				<div class="panel-body">
					<form method="POST" action="ImportsGoodsServicesMM.php">
						<div class="col-md-8">
...
?>
			<div id="cmt">
				<a href="ImportsGoodsServicesMM.php" style="color:blue;">Refresh Comments</a>
				<?php showComments($api,'ImportsGoodsServicesMM.php'); ?>   
			</div>
		</div>
		<!-- End Comments -->
	</div>
...
<!-- Scripts -->
    ...
    <script type="text/javascript">
 		google.charts.load('current', {'packages':['corechart']});
      	...
      	function showFor(){
      		window.location.href='ImportsGoodsServicesAsian.php';
      	}
      	function drawChart(){
	 		$.ajax({
				method: "GET",
				dataType: "jsonp",
				url:"http://api.worldbank.org/v2/countries/MM/indicators/NE.IMP.GNFS.ZS?date=2010:2014&format=jsonP&prefix=?",
				success: function(GDPJson){
					...
					options = {
						title: 'Imports of goods and services (% of GDP) Myanmar',
						curveType: 'function',
