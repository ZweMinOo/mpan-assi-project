...
<div class="row" style="background: none;">
  <div class="row">  
    ...
    <div class="well col-md-8">
      ...
      <h3>Population Growth (annual %) Asian</h3>
      ...
      <div id="curve_chart" class="well" style="width: auto; height: 500px; color:white;"></div>
        <section id="Table" style="display:none;">
          <h1>Population Growth (annual %) Asian</h1>
  ...
  echo <<<_END
      <div class="panel panel-info width-300px">
        <div class="panel-body">
          <form method="POST" action="PopulatoinGrowthAsian.php">
            <div class="col-md-8">
...
?>
      <div id="cmt">
        <a href="PopulatoinGrowthAsian.php" style="color:blue;">Refresh Comments</a>
        <?php showComments($api,'PopulatoinGrowthAsian.php'); ?>     
      </div>
    </div>
    <!-- End Comments -->
  </div>
...
<!-- Scripts -->
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      var api = 'SP.POP.GROW';
      function showFor(){
        window.location.href='PopulatoinGrowthMM.php';
      }
      ...
      function drawChart(year) {
        $.ajax({
          ...
          success: function (GDPJson) {
            ...
            options = {
              title: 'Population Growth (annual %) Asian '+year,
              curveType: 'function',
