    ...
    <script type="text/javascript">
	  ...
	  $.ajax({
			...
			success: function(GDPJson){
				...
				GDP_data = GDPJson[1];
				var chart_data = [];
				chart_data[0]=['Years','Million'];
				for(var GDP of GDP_data)
				{ 
					if(GDP.date=='2010')
					{
						if(GDP.value==null) GDP.value = 0;
						chart_data[1]=['2010',Number((GDP.value/100000).toFixed(2))]
					}
					else if(GDP.date=='2011')
					{
						if(GDP.value==null) GDP.value = 0;
						chart_data[2]=['2011',Number((GDP.value/100000).toFixed(2))]
					}
					else if(GDP.date=='2012')
					{
						if(GDP.value==null) GDP.value = 0;
						chart_data[3]=['2012',Number((GDP.value/100000).toFixed(2))]
					}
					else if(GDP.date=='2013')
					{
						if(GDP.value==null) GDP.value = 0;
						chart_data[4]=['2013',Number((GDP.value/100000).toFixed(2))]
					}
					else if(GDP.date=='2014')
					{
						if(GDP.value==null) GDP.value = 0;
						chart_data[5]=['2014',Number((GDP.value/100000).toFixed(2))]
					}	
				}
