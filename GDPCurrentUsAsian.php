  ...
  echo <<<_END
      <div class="panel panel-info width-300px">
        <div class="panel-body">
          <form method="POST" action="GDPCurrentUsAsian.php">
            <div class="col-md-8">
...
?>
      <div id="cmt">
        <a href="GDPCurrentUsAsian.php" style="color:blue;">Refresh Comments</a>
        <?php showComments($api,'GDPCurrentUsAsian.php'); ?>     
      </div>
    </div>
    <!-- End Comments -->
  </div>
...
<!-- Scripts -->
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function showFor(){
        window.location.href='GDPCurrentUsMM.php';
      }
      ...
      function drawChart(year) {
        $.ajax({
          ...
          success: function (GDPJson) {
            ...
            options = {
              title: 'GDP (current US$) Asian '+year,
              curveType: 'function',
