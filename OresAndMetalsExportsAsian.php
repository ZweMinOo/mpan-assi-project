...
<div class="row" style="background: none;">
  <div class="row">  
    ...
    <div class="well col-md-8">
      ...
      <h3>Ores and metals exports (% of merchandise exports) Asian</h3>
      ...
      <div id="curve_chart" class="well" style="width: auto; height: 500px; color:white;"></div>
        <section id="Table" style="display:none;">
          <h1>Ores and metals exports (% of merchandise exports) Asian</h1>
  ...
  echo <<<_END
      <div class="panel panel-info width-300px">
        <div class="panel-body">
          <form method="POST" action="OresAndMetalsExportsAsian.php">
            <div class="col-md-8">
...
?>
      <div id="cmt">
        <a href="OresAndMetalsExportsAsian.php" style="color:blue;">Refresh Comments</a>
        <?php showComments($api,'OresAndMetalsExportsAsian.php'); ?>     
      </div>
    </div>
    <!-- End Comments -->
  </div>
...
<!-- Scripts -->
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      var data,option;
      var api = 'TX.VAL.MMTL.ZS.UN';
      function showFor(){
        window.location.href='OresAndMetalsExportsMM.php';
      }
          ...
          success: function (GDPJson) {
            ...
            for(var GDP of GDP_data) {
                ...
                if (GDP.countryiso3code === 'BRN') {
                  chart_data[1] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                } else if (GDP.countryiso3code === 'IDN') {
                  chart_data[2] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                }
                else if (GDP.countryiso3code === 'KHM') {
                  chart_data[3] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                }
                else if (GDP.countryiso3code === 'LAO') {
                  chart_data[4] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                }
                else if (GDP.countryiso3code === 'MMR') {
                  chart_data[5] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                }
                else if (GDP.countryiso3code === 'MYS') {
                  chart_data[6] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                }
                else if (GDP.countryiso3code === 'PHL') {
                  chart_data[7] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                }
                else if (GDP.countryiso3code === 'SGP') {
                  chart_data[8] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                }
                else if (GDP.countryiso3code === 'THA') {
                  chart_data[9] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                }
                else if (GDP.countryiso3code === 'VNM') {
                  chart_data[10] = [GDP.country.value, Number((GDP.value).toFixed(2))]
                }         
            }
            ...
            options = {
              title: 'Ores and metals exports (% of merchandise exports) Asian '+year,
              curveType: 'function',
