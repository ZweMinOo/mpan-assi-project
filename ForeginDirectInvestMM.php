...
<div class="row" style="background: none;">
	<div class="row">
		...
		<div class="well col-md-8">
			...
			<h3>Foreign direct investment, net inflows (BoP, current US$) Myanmar</h3>
	...
	echo <<<_END
			<div class="panel panel-info width-300px">
				<div class="panel-body">
					<form method="POST" action="ForeginDirectInvestMM.php">
						<div class="col-md-8">
...
?>
			<div id="cmt">
				<a href="ForeginDirectInvestMM.php" style="color:blue;">Refresh Comments</a>
				<?php showComments($api,'ForeginDirectInvestMM.php'); ?>   
			</div>
		</div>
		<!-- End Comments -->
	</div>
...
<!-- Scripts -->
    ...
    <script type="text/javascript">
 		google.charts.load('current', {'packages':['corechart']});
      	...
      	function showFor(){
      		window.location.href='ForeginDirectInvestAsian.php';
      	}
      	function drawChart(){
	 		$.ajax({
				method: "GET",
