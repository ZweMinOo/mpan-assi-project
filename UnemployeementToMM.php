...
<div class="row" style="background: none;">
	<div class="row">
		...
		<div class="well col-md-8">
			...
			<h3>Unemployment, total (% of total labor force) (modeled ILO estimate) Myanmar</h3>
			...
			<div id="curve_chart" class="well" style="width: auto; height: 500px; color:white;"></div>
				<section id="Table" style="display:none;">
					<h1>Unemployment, total (% of total labor force) (modeled ILO estimate) Myanmar</h1>
	...
	echo <<<_END
			<div class="panel panel-info width-300px">
				<div class="panel-body">
					<form method="POST" action="UnemployeementToMM.php">
						<div class="col-md-8">
...
?>
			<div id="cmt">
				<a href="UnemployeementToMM.php" style="color:blue;">Refresh Comments</a>
				<?php showComments($api,'UnemployeementToMM.php'); ?>   
			</div>
		</div>
		<!-- End Comments -->
	</div>
...
<!-- Scripts -->
    ...
    <script type="text/javascript">
 		google.charts.load('current', {'packages':['corechart']});
      	...
      	function showFor(){
      		window.location.href='UnemployeementToAsian.php';
      	}
      	function drawChart(){
	 		$.ajax({
				method: "GET",
				...
				success: function(GDPJson){
					console.log(GDPJson);
					GDP_data = GDPJson[1];
					chart_data=[['Year','% of total labor force']];
					...
					options = {
						title: 'Unemployment, total (% of total labor force) (modeled ILO estimate) Myanmar',
						curveType: 'function',
