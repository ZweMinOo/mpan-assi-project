    ...
    <div class="well col-md-8">
      ...
      <div class="panel panel-info width-300px">
        <div class="panel-body">
          <form action="InflationCP.php" method="POST">
            <div class="col-md-8">
              <textarea id="cmt" class="form-control" name="cmt" placeholder="Comment here.." maxlength="500">
              </textarea>
            </div>
            <div class="col-md-4">
              <button type="submit" class="btn btn-default" style="width:100%;height:100%;font-size:20px;">Send
              </button>
            </div>
          </form>
        </div>
      ...
      <div id="cmt">
      <a href="InflationCP.php">Refresh Comments</a>
      <?php showComments($api) ?>     
      </div>
    </div>
    <!-- End Comments -->
  </div>
    ...
    <script type="text/javascript">
      ...
      function drawChart(year) {
        $.ajax({
          method: "GET",
          dataType: "jsonp",
          url: "http://api.worldbank.org/v2/countries/BRN;IDN;KHM;LAO;MMR;MYS;PHL;SGP;THA;VNM/indicators/BX.KLT.DINV.CD.WD?per_page=300&date="+year+"&format=jsonP&prefix=?",
    ...
    function chartType(type) {
       ...
       $(document).ready(function() {
         $('#example').DataTable( {       
          "ajax": {
            type: "GET",
            url: "http://api.worldbank.org/v2/countries/BRN;IDN;KHM;LAO;MMR;MYS;PHL;SGP;THA;VNM/indicators/BX.KLT.DINV.CD.WD?date=2010:2015&format=jsonP&prefix=?",
