		...
		<div class="well col-md-8">
			...
			<div class="panel panel-info width-300px">
				<div class="panel-body">
					<form method="POST" action="ind1.php">
						<div class="col-md-8">
...
<!-- Scripts -->
    ...
    <script type="text/javascript">
 		google.charts.load('current', {'packages':['corechart']});
      	...
      	var data,option;
      	function showFor(){
      		window.location.href='ex_GDP1.php';
      	}
      	function drawChart(){
	 		$.ajax({
				method: "GET",
		...
		function chartType(type) {
   		 ...
   		 $(document).ready(function() {
	   		 $('#example').DataTable( {				
					"ajax": {
						type: "GET",
						url: "http://api.worldbank.org/v2/countries/MM/indicators/BX.KLT.DINV.CD.WD?date=2010:2015&format=jsonP&prefix=?",
