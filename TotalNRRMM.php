...
<div class="row" style="background: none;">
	<div class="row">
		...
		<div class="well col-md-8">
			...
			<h3>Total natural resources rents (% of GDP) Myanmar</h3>
			...
			<div id="curve_chart" class="well" style="width: auto; height: 500px; color:white;"></div>
				<section id="Table" style="display:none;">
					<h1>Total natural resources rents (% of GDP) Myanmar</h1>
	...
	echo <<<_END
			<div class="panel panel-info width-300px">
				<div class="panel-body">
					<form method="POST" action="TotalNRRMM.php">
						<div class="col-md-8">
...
?>
			<div id="cmt">
				<a href="TotalNRRMM.php" style="color:blue;">Refresh Comments</a>
				<?php showComments($api,'TotalNRRMM.php'); ?>   
			</div>
		</div>
		<!-- End Comments -->
	</div>
...
<!-- Scripts -->
    ...
    <script type="text/javascript">
 		google.charts.load('current', {'packages':['corechart']});
      	...
      	function showFor(){
      		window.location.href='TotalNRRAsian.php';
      	}
      	function drawChart(){
	 		$.ajax({
				method: "GET",
				...
				success: function(GDPJson){
					...
					options = {
						title: 'Total natural resources rents (% of GDP) Myanmar',
						curveType: 'function',
