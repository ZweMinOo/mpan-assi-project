...
<div class="row" style="background: none;">
  <div class="row">  
    ...
    <div class="well col-md-8">
      ...
      <h3>Access To Electricity (% of population) Asian</h3>
      ...
      <div id="curve_chart" class="well" style="width: auto; height: 500px; color:white;"></div>
        <section id="Table" style="display:none;">
          <h1>Access To Electricity (% of population) Asian</h1>
  ...
  echo <<<_END
      <div class="panel panel-info width-300px">
        <div class="panel-body">
          <form method="POST" action="AccessToElectricityAsian.php">
            <div class="col-md-8">
...
?>
      <div id="cmt">
        <a href="AccessToElectricityAsian.php" style="color:blue;">Refresh Comments</a>
        <?php showComments($api,'AccessToElectricityAsian.php'); ?>     
      </div>
    </div>
    <!-- End Comments -->
  </div>
...
<!-- Scripts -->
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      var data,option;
      var api = 'EG.ELC.ACCS.ZS';
      function showFor(){
        window.location.href='AccessToElectricityMM.php';
      }
      ...
      function drawChart(year) {
        $.ajax({
          ...
          success: function (GDPJson) {
            ...
            options = {
              title: 'Access To Electricity (% of population) Asian '+year,
              curveType: 'function',
